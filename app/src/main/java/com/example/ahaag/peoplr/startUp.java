...
public class startUp extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserProfile currUser=new UserProfile("Jane Doe", "example@gmail.com", "Description-none", new ArrayList(), r.getDrawable(R.drawable.picture1));
        ArrayList<UserProfile> tag1 = new ArrayList<UserProfile>();
            tag1.add(new UserProfile("Mary Miller", "example@gmail.com", "Hey, how it going? I did this a lot as a kid but none of " +
                    "my friends are interested in doing it with me. I am a friendly person who loves to have " +
                    "fun.", new ArrayList(), r.getDrawable(R.drawable.picture2)));
        ...
        ArrayList<UserProfile> tag2 = new ArrayList<UserProfile>();
            ...
            tag2.add(new UserProfile("Susan Bouda", "example@gmail.com", "Hey! I am senior at uw madison. I am studying wildlife ecology" +
                    "and I love being outside. I love to laugh and hang out with my friends. I can be loud sometimes" +
                    "but I can be quiet too.", new ArrayList(), r.getDrawable(R.drawable.picture2)));
        ArrayList<UserProfile> tag3= new ArrayList<UserProfile>();
